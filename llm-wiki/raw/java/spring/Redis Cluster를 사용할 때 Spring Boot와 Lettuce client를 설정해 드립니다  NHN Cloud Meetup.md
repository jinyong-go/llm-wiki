...
source: "https://meetup.nhncloud.com/posts/379"
author:
published:
created: 2026-06-22
description: "기술을 공유하고 함께 성장해가는 개발 문화, NHN이 추구하는 가치입니다."
tags:
  - "clippings"
---
...
enableAllAdaptiveRefreshTriggers()는 Redis 클러스터에서 발행하는 모든 트리거에 대해서 토폴로지를 갱신합니다. 트리거는 MOVED\_REDIRECT, ASK\_REDIRECT, PERSISTENT\_RECONNECTS, UNCOVERED\_SLOT, UNKNOWN\_NODE 등이 될 수 있습니다.
...
- DynamicCommandTimeout 객체는 기본 timeout 값으로 100ms를 설정하고, META\_COMMAND\_TYPES에 정의된 명령어에 대해서는 300ms로 설정한 예제입니다.
```java
...
RedisClusterNode.NodeFlag 열거형의 자세한 내용은 [여기](https://lettuce.io/core/release/api/io/lettuce/core/cluster/models/partitions/RedisClusterNode.NodeFlag.html) 에서 확인하길 바랍니다.
...
- AWS, Lettuce 클라이언트 구성, [https://docs.aws.amazon.com/AmazonElastiCache/latest/red-ug/BestPractices.Clients-lettuce.html](https://docs.aws.amazon.com/AmazonElastiCache/latest/red-ug/BestPractices.Clients-lettuce.html)
...
[이전글](https://meetup.nhncloud.com/posts/380) 이전글 [다음글](https://meetup.nhncloud.com/posts/378) 다음글
