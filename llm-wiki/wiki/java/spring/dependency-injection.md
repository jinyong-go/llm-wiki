...
Spring 컨테이너가 빈에 의존성을 주입하는 방식은 크게 **생성자 주입**과 **Setter 주입**이며,
어노테이션 기반에서는 **필드 주입**과 임의 설정 메서드 주입도 가능하다.
Spring 팀의 공식 권장은 **필수 의존성은 생성자, 선택 의존성은 Setter**다.
